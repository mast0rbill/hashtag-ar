import { AvGadgetManifest, AvPanelMouseEventType, EndpointAddr, MsgGrabberState, MsgPokerProximity, AvSharedTextureInfo, EHand, AABB as Aabb } from './aardvark_protocol';
...
interface AvRenderer {
    ...
    addGrabbableHandle_Sphere(grabbableGlobalId: EndpointAddr, handleGlobalId: EndpointAddr, universeFromHandle: number[], radius: number, hand: EHand): void;
    addGrabbableHandle_ModelBox(grabbableGlobalId: EndpointAddr, handleGlobalId: EndpointAddr, universeFromHandle: number[], uri: string, hand: EHand): void;
...
export declare function Av(): Aardvark;
export {};
